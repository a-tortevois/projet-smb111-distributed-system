...
import fr.tortevois.gateway.UdpGateway;
...
public class UdpGatewayBootloader {
    ...
    public static void main(String[] args) {
        ...
        if (address != null && port > 1024) {
            printTrace(DEBUG, OUT, "Start the Gateway " + address + ":" + port);
            // Create a new gateway and get the distributor
            UdpGateway gateway = new UdpGateway(address, port);
            ...
            System.err.println("Unable to start the Gateway " + address + ":" + port);
            System.exit(-1);
        }
    }

    private static void usage() {
        System.err.println("Usage: java StartUdpGateway IPv4_address port");
        System.exit(-1);
    }
}
